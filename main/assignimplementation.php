                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <td colspan="4"><div class="imp_dashboard_module" >
                                                                      <table width="100%" border="0" cellspacing="0" cellpadding="4" > <tr>
                                                                        ...
                                                                        <tr>
                                                                          <td width="14%">Date:</td>
                                                                          <td width="37%"><input name="DPC_attachfromdate3" type="text" class="swifttext-mandatory" id="DPC_attachfromdate3" size="30" autocomplete="off" value="<? echo(datetimelocal('d-m-Y')); ?>" readonly="readonly"/></td>
                                                                          <td width="12%" valign="top">Remarks:</td>
