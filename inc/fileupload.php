...
switch($id)
{
	...
	case '2':
			{
				$filebasename = 'CUF'.'-'.$cusid.'-'.$date.basename($_FILES[$namefile]['name']);
				$attachfilename = trim('CUF'.'-'.$cusid.'-'.$date.basename($_FILES[$namefile]),'-');
	...
	case '5':
			{	
				$filebasename = 'BDU'.'-'.$cusid.'-'.$date.basename($_FILES[$namefile]['name']);
				$attachfilename = trim('BDU'.'-'.$cusid.'-'.$date.basename($_FILES[$namefile]),'-');
